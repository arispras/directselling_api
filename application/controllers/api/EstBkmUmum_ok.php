...
class EstBkmUmum extends BD_Controller
{
	...
	public function list_post()
	{
		...
		$query  = "SELECT a.*,b.nama as lokasi,c.nama as rayon_afdeling FROM `est_bkm_umum_ht` a left join gbm_organisasi b on a.lokasi_id=b.id
...
";
	...
	function laporan_umum_post()
	{
		...
		g.keterangan AS ket_absen FROM est_bkm_umum_dt a
