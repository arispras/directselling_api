...
<html>
	<head>
	<title>A.04 Purchase Order Unpaid</title>
	...
	<?php 
		...
		<h3 class="title">A.04 Purchase Order Unpaid</h3>
		<br>
		...
		<table class="table-bg border">				
			...
			<tbody>
				...
				<tr>
					<td bold colspan=7><?= $val['nama_supplier'] ?></td>
				</tr>
				...
				<?php } ?>
				<tr>
					<td colspan='4' right >TOTAL <?= $res['nama_supplier'] ?></td>
