<!DOCTYPEhtml>
	...
	<body>
		...
		<table class="table-bg">
			...
			<tr>
				<td><?= $no ?></td>
				<td><?= $val['item_nama'] . ' (' . $val['nama_uom'] . ') <br> ' . $val['no_po'] ?></td>
			...
			<tr>
				<td></td>
				<td style="height:10%">Jatuh Tempo: SEGERA</td>
				<td></td>
				<td></td>
				<td></td>
			</tr>
			<tr>
				...
				<td colspan="2" right>Rp. <?= number_format($po['sub_total']) ?></td>
			</tr>
			<tr>
				<td colspan="3">Potongan Harga (Discount)</td>
				<td colspan="2" right>Rp. <?= number_format($po['diskon']) ?></td>
			</tr>
			<tr>
				<td colspan="3">Uang Muka</td>
				<td colspan="2" right>Rp. <?= number_format($po['uang_muka']) ?></td>
			</tr>
			<tr>
				<td colspan="3">Dasar Pengenaan Pajak (DPP)</td>
				<td colspan="2" right>Rp. <?= number_format($po['sub_total'] - $po['diskon']) ?></td>
			</tr>
			<?php $ppn_total = ($po['ppn'] / 100) * $po['sub_total']; ?>
			<tr>
			...
			<tr>
				...
				<td colspan="2" right>Rp. <?= number_format($po['grand_total']) ?></td>
			</tr>
			<tr>
				<td colspan="5">
					<br>
					<div>Terbilang</div>
					<div><i>&nbsp;&nbsp;&nbsp;&nbsp;<?= terbilang($po['grand_total']) ?></i></div>
					<br>
				</td>
			</tr>
		</table>
