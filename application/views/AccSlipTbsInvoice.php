	...
	<body>
		...
		<table class="table-bg border">
			...
			<tbody>
				...
				<tr><td colspan="4">BAPB Tanggal:<?= tgl_indo($hd['tanggal_rekap']) ?></td><td>PPN</td>	<td right width="10%"><?= number_format(floor($hd['ppn']/100*$hd['sub_total'])) ?></td></tr>
				<tr><td colspan="4"></td><td>PPh</td>	<td style="color:red" right width="10%"><?= "(". number_format(floor($hd['pph']/100*$hd['sub_total'])) .")" ?></td></tr>
