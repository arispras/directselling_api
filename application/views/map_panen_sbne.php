...
*/
	...
	<script type="text/javascript">
		...
		function getdata(periode) {
			...
			waitingDialog.show();
			$.getJSON("<?php echo base_url(); ?>api/mapPanenSbne/retrieve_data?periode=" + periode, function(data) {
				// Success
				var areas = {};
			...
			function showdetail(blok, periode) {
				periode = (periode !== undefined) ? periode : "";
				waitingDialog.show();
				$('iframe').attr('src', '<?php echo base_url(); ?>api/mapPanenSbne/show_detail?blok=' + blok + '&periode=' + periode);
...
<body>
	...
	<div class="container">
		<h3>MAP BERDASARKAN PANEN SBNE</h3>
