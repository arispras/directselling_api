...
<html>
	...
	<body>
		...
		<h1 class="title">FORM REALISASI PERJALANAN DINAS</h1>
		<br>
		...
		<table class="table-bg border">
			...
			<?php foreach ($detail as $key=>$val) { ?> 
				...
				<tr>
					...
					<td center width="7%"><?= number_format($val['nilai']) ?></td>
				...
				<tr>
				<td right colspan=4> Total Realisasi</td>
				<td right><?= number_format($ttl_nilai) ?> </td>
				<td></td>
				</tr>

				<tr>
				<td right colspan=4> Total Uang Muka </td>
				<td right><?= number_format($sum['total']) ?> </td>
				<td></td>
				</tr>
			</tbody>
