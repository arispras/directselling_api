			...
			<tbody>
				...
				<?php foreach ($data as $key => $res) { ?>
					<tr>
						...
						$jum_nilai_anguran +=  $res['nilai_angsuran'];
						// $jum_sisa_akhir +=  $res['sisa_akhir'];
				...
				<tr>
					<td colspan=8></td>
					<td right><?= format_number_report($jum_nilai_anguran, $format_laporan) ?></td>
					<td right width="8%"><?= format_number_report($jum_sisa_angsuran, $format_laporan) ?></td>
					<td right width="8%"><?= format_number_report($jum_dibayar, $format_laporan) ?></td>
					<td right width="8%"><?= format_number_report($jum_sisa_akhir, $format_laporan) ?></td>
					<td right></td>
