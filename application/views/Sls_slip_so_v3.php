<!DOCTYPEhtml>
	...
	<body>
		...
		<table class="header" border="0">
			<tr>
				...
				<td width="25%" style="padding:0 0px">
					...
					<table>
						...
						<tr>
							<td>Jl Kemang Timur Raya - Komp. IAPCO No. 20
							</td>
						</tr>
						<tr>
				...
				<td width="33%" style="padding:0 0px">
					<table >
						...
						<tr>
							<td left bold width="13%">SO No</td>
							<td  width="4%">:</td>
							<td left width="70%"><?=  $header['no_so'] ?></td>
						</tr>
			...
			<table>
				<tr>
					<td><h1 center style="font-size:16px"  >SALES ORDER</h1></td>
				</tr>
			</table>
		</table>
		<table border="0">
			<tr>
				<td width="30%" style="padding:0 0px">
					<table>
						...
						<tr>
							<td left bold> <i><?= $header['nama_customer'] ?></i> </td>
						</tr>
						<tr>
							<td left><?= $header['alamat_customer'] ?></td>
						</tr>
						<tr>
							<td left>Phone : <?= $header['no_telepon_customer'] ?></td>
						</tr>
						<tr>
							<td left>PIC : <?= $header['contact_person_customer'] ?></td>
						</tr>
					</table>
				</td>
				...
				<td width="33%" style="padding:0 0px">
					<table>
						...
						<tr>
							<!-- <td left bold> <i><?= $header['nama_lokasi_pp'] ?></i> </td> -->
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
