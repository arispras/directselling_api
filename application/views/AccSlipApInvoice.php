	...
	<table style="padding:10px 0;">
			<tr>
				...
				<td width="27%" style="padding:0 10px">
					...
					<table>
						<tr>
							<h1 style="font-size:15px"  >AP VOUCHER</h1>
						</tr>
					</table>
				</td>
				<td width="30%" style="padding:0 20px">
					<table class="table-bg border">
						...
						<tr>
							<td center >Supplier <br> <h1><?= $hd['nama_supplier'] ?></h1>  </td>
						</tr>
					</table>
				</td>
			</tr>
		...
		<table class="table-bg border" >
			<tr>
				...
				<table  >
					<!-- style="border:0px" -->
						<tr >
							<td style="border:0px" width="38%">Invoice Supplier </td>
							<td style="border:0px; padding:0;" width="1">:</td>
							<td style="border:0px; " ><?= $hd['no_invoice_supplier'] ?></td>
						</tr>
						<tr>
...
<br>
		...
		<table class="table-bg border">
			...
			<tbody>
				...
				<tr>
					<?php
					$tot_cr = $tot_cr + $hd['nilai_invoice'];
