<!DOCTYPEhtml>
	...
	<body>
		...
		<h3 class="title">Tarik Barang REKAP</h3>
		<br>
		...
		<table class="table-bg border">
			...
			<tbody>
				...
				?>
					...
					<?php foreach ($data as $key => $res) { ?>
						<tr>
							...
							$jum_nilai_pendapatan_tarik_barang += $res['nilai_pendapatan_tarik_barang'];
							$jum_qty += $res['qty'];
							?>
							<td center> <?= $no ?> </td>
				...
				<tr>
					...
					<td right><?= format_number_report($jum_nilai_pendapatan_tarik_barang,$format_laporan) ?></td>
					<td right><?= format_number_report(($jum_total-$jum_nilai_pendapatan_tarik_barang),$format_laporan) ?></td>
				</tr>
