...
<?php require '__laporan_header.php' ?>
    <!-- <div>
        <div class="kop-print">
            ...
            <div class="kop-info">Alamat: Jln. Sample Km 02, Telepon: +62 8998321134</div>
        </div>
    ...
    <br>
    <h3>Surat Jalan Pengiriman Produk</h3>
    <br>
    ...
    <table>
        <tr>
            ...
            <td width='10px'>:</td>
            <td><?= tgl_indo($PksSjpp['tanggal']) ?></td>
        </tr>
        <tr>
            <td>Nama Pengemudi</td>
            <td>:</td>
            <td><?= $PksSjpp['nama_pengemudi'] ?></td>
        </tr>
        <tr>
            <td>No Surat</td>
            <td>:</td>
            <td><?= $PksSjpp['no_surat'] ?></td>
        </tr>
        <tr>
            <td>No Polisi</td>
            <td>:</td>
            <td><?= $PksSjpp['no_polisi'] ?></td>
        </tr>
        <tr>
            <td>Berat Kirim</td>
            <td>:</td>
            <td><?= $PksSjpp['berat_kirim'] ?></td>
        </tr>
    </table>
    ...
    <table class="tab-expand border">
        ...
        <tr>
            <td><?= $PksSjpp['kode_produk'] ?></td>
            <td><?= $PksSjpp['nama_produk'] ?></td>
            <td style="text-align:center"><?= $PksSjpp['satuan'] ?></td>
            <td><?= $PksSjpp['harga_beli'] ?></td>
        </tr>
    </table>
