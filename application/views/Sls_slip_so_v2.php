<!DOCTYPEhtml>
		...
		<table style="padding:10px 0;">
			<tr>
				...
				<td width="27%" style="padding:0 10px">
					...
					<table>
						<tr>
							<h1 style="font-size:15px"  >SALES ORDER</h1>
						</tr>
					</table>
				</td>
				<td width="25%" style="padding:0 20px">
					<table class="table-bg border">
						...
						<tr>
							<td center colspan="2">SO Number <br> <h1><?= $header['no_so'] ?></h1> </td>
						</tr>
						<tr>
		...
		<table class="table-bg border" >
			<tr>
				...
				<table  >
					<!-- style="border:0px" -->
						<tr >
							<td style="border:0px" width="30%">Customer Name </td>
							<td style="border:0px; padding:0;" width="1">:</td>
							<td style="border:0px; " ><?= $header['nama_customer'] ?></td>
						</tr>
						<tr>
							<td style="border:0px;" >  Customer Address</td>
							<td style="border:0px; padding:0;" >:</td>
							<td style="border:0px;  " ><?= $header['alamat_customer'] ?></td>
						</tr>
						<tr>
							<td style="border:0px" >Customer PIC </td>
							<td style="border:0px; padding:0;" >:</td>
							<td style="border:0px; "><?= $header['contact_person_customer'] ?></td>
						</tr>
						<tr>
							<td style="border:0px">Phone Number</td>
							<td style="border:0px; padding:0;">:</td>
							<td style="border:0px; "><?= $header['no_telepon_customer'] ?></td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td center colspan=""> Customer Quotation / Contract Ref <h1><?= $header['qoutation'] ?></h1></td>
	...
	<table class="table-bg border">
		...
		<ol>
			...
			<li>Customer menjamin keabsahan barang yang dijual serta membebaskan pihak pembeli 	
...
<br>
		<table>
			<tr>
				...
				<td center>
					<p bold>Customer Confirmation</p>
					<br><br><br><br><br>
