<!DOCTYPEhtml>
	...
	<head>
	<title>Purchase Order Status Summary</title>
	...
	<body>
		...
		<br>
		<div center>
			<h3 class='title'>C.02 STATUS PURCHASE ORDER SUMMARY</h1>
		</div>
		<br>
		...
		<table class="table-bg border">
			<thead>
				<tr>
					...
					<th style="width:8%">Nilai PO (Rp)</th>
					<th style="width:5%">Tanggal Penerimaan</th>
					<th style="width:7%">No Penerimaan</th>
					<th style="width:7%">No SJ Supplier</th>
			...
			<tbody>
				...
				<?php foreach ($po as $key => $val) { ?>
					...
					<tr>
						...
						<td><?= $val['no_surat_jalan_supplier'] ?></td>
						<td><?= $val['status'] ?></td>
						<!-- <td>23/01/2022</td> -->
					</tr>
				<?php } ?>
