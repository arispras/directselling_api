...
<html>
	<head>
	<title>A.09 Purchase Order by Vendor</title>
	...
	<?php 
		...
		<h3 class="title">A.09 Purchase Order by Vendor</h3>
		<br>
		...
		<table class="table-bg border">				
			...
			<tbody>
				...
				<tr>
					<td bold colspan=9><?= $val['nama_supplier'] ?></td>
				</tr>
				...
				<tr>
					...
					<!-- <td center width="17%"><?= $res['nama_supplier'] ?></td> -->
				...
				<?php } ?>
				<tr>
					<td colspan='7' right >TOTAL <?= $res['nama_supplier'] ?></td>
