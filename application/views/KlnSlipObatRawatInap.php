		...
		<table style="padding:10px 0;">
			<tr>
				...
				<td width="27%" style="padding:0 10px">
					...
					<table>
						<tr>
							<h1 style="font-size:15px"  >Daftar Obat</h1>
						</tr>
					</table>
				</td>
...
<br>
		<table class="table-bg border">
			<thead>
				<tr>
					<th rowspan="0">No</th>
					<th rowspan="0">Obat</th>
					<th rowspan="0">Satuan</th>
					<th rowspan="0">Dosis</th>
					<th rowspan="0">Instruksi</th>
					<th rowspan="0">Qty</th>
	...
	<tbody>
				...
				<?php foreach ($dt as $key => $val) { ?>
					...
					<tr>
						...
						<td center width="10%"><?= $val['kode_barang'] . '-' . $val['nama_barang'] ?></td>
						<td center width="10%"><?= $val['uom'] ?></td>					
						<td center width="10%"><?= $val['dosis'] ?></td>
						<td center width="10%"><?= $val['instruksi'] ?></td>
						<td center width="10%"><?= number_format($val['qty']) ?></td>
