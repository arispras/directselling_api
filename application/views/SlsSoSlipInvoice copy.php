				...
				<td style="padding:0 20px">
					...
					<table>
						<tr>
							...
							<td style="width:4%">:</td>
							<td><?= tgl_indo($invoice['tanggal']) ?></td>
						</tr>
						<tr>
							<td>Faktur</td>
							<td>:</td>
		...
		<table class="table-bg border">
			<tbody>
				...
				<tr>
					...
					<td right bold>Rp. <?= number_format($invoice['nilai_invoice']) ?></td>
				</tr>
				<tr>
					<td right bold>Uang Muka (<?= number_format($invoice['dp_persen'],0) ?>%)</td>
					<td right bold>Rp. <?= number_format($invoice['dp_persen']/100*$invoice['nilai_invoice']) ?></td>
				</tr>
				<tr>
					<td right bold>Sisa Pembayaran</td>
					<td right bold>Rp. <?= number_format($invoice['nilai_invoice'] - ($invoice['dp_persen']/100*$invoice['nilai_invoice']) ) ?></td>
				</tr>
			</tbody>
			<tfoot></tfoot>
		</table>
