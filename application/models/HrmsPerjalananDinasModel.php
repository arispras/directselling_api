...
class HrmsPerjalananDinasModel extends CI_Model
{
	...
	public function create(
		...
		$this->db->insert('hrms_perjalanan_dinas_ht', $data);
		$id = $this->db->insert_id();

		$details = $input['details'];
		foreach ($details as $key => $value) {
			$this->db->insert("hrms_perjalanan_dinas_dt", array(
	...
	public function update($id,	$input) 
	{
		...
		$this->db->where('id', $id);
		$this->db->update('hrms_perjalanan_dinas_ht', $data);

		// hapus  detail
		$this->db->where('perjalanan_dinas_id', $id);
		$this->db->delete('hrms_perjalanan_dinas_dt');
	...
	public function delete($id)
	{
		...
		$this->db->delete('hrms_perjalanan_dinas_dt');
		$this->db->where('id', $id);
		$this->db->delete('hrms_perjalanan_dinas_ht');
		return true;
	}
	...
	public function retrieve_all()
    {
        ...
        $result = $this->db->get('hrms_perjalanan_dinas_ht');
        return $result->result_array();
    }
	
	public function retrieve_all_detail($id)
	{
		$this->db->from('hrms_perjalanan_dinas_dt');
		$this->db->where('perjalanan_dinas_id', $id);
	...
	{
		$this->db->select('*');
		$this->db->from('hrms_perjalanan_dinas_ht');
		$this->db->where('id', $id);
		$res = $this->db->get();
	...
	public function retrieve_detail($hdid)
	{
		$this->db->select('*');
		$this->db->from('hrms_perjalanan_dinas_dt');
		$this->db->where('perjalanan_dinas_id', $hdid);
		$res = $this->db->get();
