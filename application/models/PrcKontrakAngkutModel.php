...
class PrcKontrakAngkutModel extends CI_Model
{
	...
	public function delete($id)
	{
		...
		$this->db->where('id', $id);
		$this->db->delete('prc_kontrak_angkut');
		return true;
	}
	...
	public function retrieve($id)
	{
		...
		$this->db->where('id', $id);
		$result = $this->db->get('prc_kontrak_angkut', 1);
		return $result->row_array();
	}
	public function retrieve_all()
	{
		$query  = "select a.*,b.nama as nama_lokasi, e.nama as mill,c.nama_customer as customer ,d.nama as nama_item from prc_kontrak_angkut a 
		left join gbm_organisasi b on a.lokasi_id=b.id 
		left join gbm_customer c on a.supplier_id=c.id 
	...
	public function retrieve_all_by_customer($supplier_id)
	{
		$query  = "select a.*,b.nama as nama_lokasi, e.nama as mill,c.nama_customer as customer ,d.nama as nama_item from prc_kontrak_angkut a 
		left join gbm_organisasi b on a.lokasi_id=b.id 
		left join gbm_customer c on a.supplier_id=c.id 
	...
	public function create(
		...
		$this->db->insert('prc_kontrak_angkut', $data);
	...
	public function update(
		...
		$this->db->where('id', $id);
		$this->db->update('prc_kontrak_angkut', $data);
		return true;
	}
}
