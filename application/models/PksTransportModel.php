...
class PksTransportModel extends CI_Model
{
    ...
    public function retrieve_all(
        ...
        $data = $this->pager->set('pks_transport', $no_of_records, $page_no, $where);
    ...
    public function retrieve_all_kategori()
    {
        ...
        $result = $this->db->get('pks_transport');
    ...
    public function update($id, $input)
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('pks_transport', $input);
        return true;
    }
    ...
    public function retrieve($id)
    {
        ...
        $this->db->where('id', $id);
        $result = $this->db->get('pks_transport', 1);
    ...
    public function create($input)
    {
        ...
        $this->db->insert('pks_transport', $input);
