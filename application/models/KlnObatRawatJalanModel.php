...
class KlnObatRawatJalanModel extends CI_Model
{
	...
	public function retrieve_all()
	{
		...
		$result = $this->db->get('kln_obat_rawat_jalan');
	...
	{
		$id = (int)$id;
		$this->db->where('kln_obat_id', $id);
		$this->db->delete('kln_obat_rawat_jalan_dt');
		$this->db->where('id', $id);
		$this->db->delete('kln_obat_rawat_jalan_ht');
		return true;
	}
	...
	public function update($id, $input)
	{
		...
		$this->db->where('id', $id);
		$this->db->update('kln_obat_rawat_jalan_ht', $ht);
		...
		foreach ($details as $key => $value) {
			$this->db->insert("kln_obat_rawat_jalan_dt", array(
				'kln_obat_id' => $id,
	...
	public function posting($id,	$input)
	{
		...
		$this->db->where('id', $id);
		$this->db->update('kln_obat_rawat_jalan', $data);	
	...
	public function retrieve($id)
	{
		...
		$this->db->where('id', $id);
		$result = $this->db->get('kln_obat_rawat_jalan_ht', 1);
	...
	public function retrieve_detail($hdid)
	{
		...
		$this->db->from('kln_obat_rawat_jalan_dt a');
		$this->db->join('inv_item b', 'a.item_id = b.id', 'Left');
		$this->db->where('a.kln_obat_id', $hdid);
		$res = $this->db->get();
	...
	public function create($input)
	{
		...
		$this->db->insert('kln_obat_rawat_jalan_ht', $ht);
