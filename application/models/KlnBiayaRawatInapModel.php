...
class KlnBiayaRawatInapModel extends CI_Model
{
	...
	public function retrieve_all()
	{
		...
		$result = $this->db->get('kln_biaya_rawat_inap');
	...
	public function delete($id)
	{
		...
		$this->db->where('id', $id);
		$this->db->delete('kln_biaya_rawat_inap');
		return true;
	}
	...
	public function update($id, $input)
	{
		...
		$ht['rawat_inap_id'] = $input['rawat_inap_id'];
		...
		$this->db->where('id', $id);
		$this->db->update('kln_biaya_rawat_inap', $ht);

		// hapus  detail
		// $this->db->where('diagnosa_id', $id);
		// $this->db->delete('kln_biaya_rawat_inap_dt');

		// $details = $input['details'];
		// foreach ($details as $key => $value) {
		// 	$this->db->insert("kln_biaya_rawat_inap_dt", array(
		// 		'diagnosa_id' => $id,
	...
	public function posting($id,	$input)
	{
		...
		$this->db->where('id', $id);
		$this->db->update('kln_biaya_rawat_inap', $data);	
	...
	public function retrieve($id)
	{
		...
		$this->db->where('id', $id);
		$result = $this->db->get('kln_biaya_rawat_inap', 1);
	...
	public function retrieve_detail($hdid)
	{
		...
		$this->db->from('kln_biaya_rawat_inap_dt a');
	...
	public function create($input)
	{
		...
		$this->db->insert('kln_biaya_rawat_inap', $ht);
