...
class InvPenerimaanTanpaPoModel extends CI_Model
{
    ...
    public function retrieve_all(
        ...
        $data = $this->pager->set('inv_penerimaan_tanpa_po_ht', $no_of_records, $page_no, $where);
    ...
    public function retrieve_all_kategori()
    {
        ...
        $result = $this->db->get('inv_penerimaan_tanpa_po_ht');
    ...
    public function delete($id)
    {
        ...
        $this->db->where('id', $id);
        $this->db->delete('inv_penerimaan_tanpa_po_ht');
        return true;
    }
    ...
    public function update($id, $input)
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('inv_penerimaan_tanpa_po_ht', $ht);

        // hapus  detail
		$this->db->where('penerimaan_tanpa_po_id', $id);
		$this->db->delete('inv_penerimaan_tanpa_po_dt');

        $details = $input['details'];
		foreach ($details as $key => $value) {
			$this->db->insert("inv_penerimaan_tanpa_po_dt", array(
				'penerimaan_tanpa_po_id' => $id,
	...
	public function posting($id,	$input) 
	{
		...
		$data_transaksi=$this->db->query("select * from inv_penerimaan_tanpa_po_ht a
		inner join inv_penerimaan_tanpa_po_dt b on a.id=b.penerimaan_tanpa_po_id  
    ...
    public function retrieve($id)
    {
        ...
        $this->db->where('id', $id);
        $result = $this->db->get('inv_penerimaan_tanpa_po_ht', 1);
	...
	{
		// 	$this->db->select('*');
		// $this->db->from('inv_penerimaan_tanpa_po_dt');
		// $this->db->where('penerimaan_tanpa_po_id', $hdid);
		$this->db->select('a.*,b.kode as kode_barang,b.nama as nama_barang,c.acc_akun_id,d.kode as uom');
		$this->db->from('inv_penerimaan_tanpa_po_dt a');
		...
		$this->db->where('a.penerimaan_tanpa_po_id', $hdid);
		$res = $this->db->get();
    ...
    public function create($input)
    {
        ...
        $this->db->insert('inv_penerimaan_tanpa_po_ht', $ht);
