...
class HrmsPromosiModel extends CI_Model
{
    ...
    public function retrieve_all(
        ...
        $data = $this->pager->set('hrms_promosi', $no_of_records, $page_no, $where);

        return $data;
    }


    //  Method untuk mendapatkan semua data hrms_promosi tanpa pagging

    public function retrieve_all_kategori()
    {
        $this->db->order_by('no_transaksi', 'ASC');
        $result = $this->db->get('hrms_promosi');
        return $result->result_array();
    }


    //   Method untuk menghapus record hrms_promosi
    ...
    public function update($id, $input)
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('hrms_promosi', $data);
        return true;
    }


    //  Method untuk mengambil satu record hrms_promosi
    ...
    public function retrieve($id)
    {
        ...
        $this->db->where('id', $id);
        $result = $this->db->get('hrms_promosi', 1);
        return $result->row_array();
    }


    //  Method untuk membuat data hrms_promosi
    ...
    public function create($input)
    {
        ...
        $this->db->insert('hrms_promosi', $data);
