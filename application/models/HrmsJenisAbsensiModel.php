...
class HrmsJenisAbsensiModel extends CI_Model
{
    ...
    public function retrieve_all(
        ...
        $data = $this->pager->set('hrms_jenis_absensi', $no_of_records, $page_no, $where);
    ...
    public function retrieve_all_kategori()
    {
        ...
        $result = $this->db->get('hrms_jenis_absensi');
    ...
    public function delete($id)
    {
        ...
        $this->db->where('id', $id);
        $this->db->delete('hrms_jenis_absensi');
        return true;
    }
    ...
    public function update($id, $input)
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('hrms_jenis_absensi', $input);
        return true;
    }
    ...
    public function retrieve($id)
    {
        ...
        $this->db->where('id', $id);
        $result = $this->db->get('hrms_jenis_absensi', 1);
    ...
    public function create($input)
    {
        ...
        $this->db->insert('hrms_jenis_absensi', $input);
