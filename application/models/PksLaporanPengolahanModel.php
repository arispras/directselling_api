...
class PksLaporanPengolahanModel extends CI_Model
{
    ...
    public function laporanLembur( $input='' )
    {
        ...
        // $this->db->join("hrms_jenis_lembur c", "a.jenis_lembur_id = c.id");
    ...
    public function laporanLemburBulanan( $input='' )
    {
        ...
        $this->db->from("payroll_lembur a");
        $this->db->join("karyawan b", "a.karyawan_id = b.id");
        $this->db->join("gbm_organisasi c", "b.sub_bagian_id = c.id");
    ...
    public function laporanPengolahan( $input='' )
    {
        $this->db->select("
            a.*
        ");
        ...
        $this->db->from("pks_pengolahan_ht a");
         $this->db->where("mill_id", $input['lokasi_id']);
