...
class PrcFrancoModel extends CI_Model
{
    ...
    public function retrieve_all(
        ...
        $data = $this->pager->set('prc_franco', $no_of_records, $page_no, $where);
    ...
    public function update($id, $input)
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('prc_franco', $input);
        return true;
    }
    ...
    public function retrieve($id)
    {
        ...
        $this->db->where('id', $id);
        $result = $this->db->get('prc_franco', 1);
    ...
    public function create($input)
    {
        ...
        $this->db->insert('prc_franco', $input);
