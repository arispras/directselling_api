...
class PksTankiFormula1Model extends CI_Model
{
    ...
    public function retrieve_all(
        ...
        $data = $this->pager->set('pks_tanki_formula1', $no_of_records, $page_no, $where);
    ...
    public function retrieve_all_kategori()
    {
        ...
        $result = $this->db->get('pks_tanki_formula1');
    ...
    public function delete($id)
    {
        ...
        $this->db->where('id', $id);
        $this->db->delete('pks_tanki_formula1');
        return true;
    }
    ...
    public function update($id, $input)
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('pks_tanki_formula1', $input);
        return true;
    }
    ...
    public function retrieve($id)
    {
        ...
        $this->db->where('id', $id);
        $result = $this->db->get('pks_tanki_formula1', 1);
    ...
    public function create($input)
    {
        ...
        $this->db->insert('pks_tanki_formula1', $input);
