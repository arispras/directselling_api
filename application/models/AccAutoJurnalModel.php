...
class AccAutoJurnalModel extends CI_Model
{
	private $table = 'acc_auto_jurnal';
	...
	public function retrieve_all_akun()
	{
		...
		$result = $this->db->get('acc_auto_jurnal');
	...
	public function retrievebyId($id)
	{
		...
		$result = $this->db->get('acc_auto_jurnal', '1');
		return $result->row_array();
	}
	...
	public function update(
		...
		$this->db->update($this->table, array(
			...
			'acc_akun_id_debet' => $input['acc_akun_id_debet'],
			'acc_akun_id_kredit' => $input['acc_akun_id_kredit'],
			'kode' => $input['kode'],
			'ket' => $input['ket'],
